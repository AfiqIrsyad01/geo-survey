...
--
-- Host: localhost:3306
-- Generation Time: Mar 30, 2026 at 06:44 AM
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','staff','hod') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'staff',
...
ALTER TABLE `approvals`
  ADD PRIMARY KEY (`id`),
  ADD KEY `approvals_survey_id_foreign` (`survey_id`),
...
--
-- Indexes for table `survey_images`
--
ALTER TABLE `survey_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `survey_images_survey_id_foreign` (`survey_id`);
...
--
-- AUTO_INCREMENT for table `survey_images`
--
ALTER TABLE `survey_images`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `approvals`
  ADD CONSTRAINT `approvals_survey_id_foreign` FOREIGN KEY (`survey_id`) REFERENCES `surveys` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `surveys`
  ADD CONSTRAINT `surveys_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `survey_details`
  ADD CONSTRAINT `survey_details_survey_id_foreign` FOREIGN KEY (`survey_id`) REFERENCES `surveys` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `survey_images`
--
ALTER TABLE `survey_images`
  ADD CONSTRAINT `survey_images_survey_id_foreign` FOREIGN KEY (`survey_id`) REFERENCES `surveys` (`id`) ON DELETE CASCADE;
COMMIT;
